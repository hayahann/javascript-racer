...
var Render = {
  ...
  cityelem: function(ctx, width, height, resolution, roadWidth, sprites, sprite, scale, destX, destY, offsetX, offsetY, clipY) {
  ...
  billboard: function(ctx, width, height, resolution, roadWidth, sprites, sprite, scale, destX, destY, offsetX, offsetY, clipY) {
    //  scale for projection AND relative to roadWidth (for tweakUI)
    var destW  = (sprite.w * scale * width) * (SPRITES.SCALE * roadWidth);
    var destH  = (sprite.h * scale * width) * (SPRITES.SCALE * roadWidth);
...
var COLORS = {
  ...
  TREE: '#4F1D04',
  FOG:  '#4F1D04',
  LIGHT:  { road: '#6B6B6B', grass: '#56616A', rumble: '#CCCCCC', lane: '#CCCCCC'  },
  DARK:   { road: '#696969', grass: '#3B4358', rumble: '#CCCCCC'                   },
...
var OBSTACLES = {
  HAPPYMEAL:              { x: 0, y:  0, w:   1500, h:   1000 }//{ x: 0, y:  0, w:   1500, h:   1000 } // HAPPY MEAL
};
...
var CITYELEMS = {
  LAMP:              { x:    5, y:    5, w:  215, h:  540 },
  PIZZA:            { x:  230, y:    5, w:  385, h:  265 },
  CONBINI:                  { x:  625, y:    5, w:  360, h:  360 },
  FOUNTAIN:             { x:    5, y:  555, w:  135, h:  332 },
  BIKE:            { x:  150, y:  555, w:  328, h:  282 },
  ATM:               { x:  230, y:  280, w:  320, h:  220 },
  BUSSTOP:                 { x:  995, y:    5, w:  200, h:  315 },
  TELEPHONE:            { x:  625, y:  375, w:  300, h:  170 },
  BENCH:            { x:  488, y:  555, w:  298, h:  190 },
  PUMP:            { x:    5, y:  897, w:  298, h:  190 },
  BUILDING1:            { x:  313, y:  897, w:  298, h:  190 },
  BUILDING2:               { x:  621, y:  897, w:  298, h:  140 },
  NPC:               { x:  621, y:  897, w:  298, h:  140 }
};
...
CITYELEMS.SCALE = 0.3 * (1/SPRITES.PLAYER_STRAIGHT.w) // the reference sprite width should be 1/3rd the (half-)roadWidth
