...
task 'resprite' do
  ...
  SpriteFactory.run!('images/billbboards', :layout => :packed, :output_style => 'images/billbboards.js', :margin => 5, :nocomments => true) do |images|
    SpriteHelper.javascript_style("BILLBOARDS", images)
  end

  SpriteFactory.run!('images/cityelems', :layout => :packed, :output_style => 'images/cityelems.js', :margin => 5, :nocomments => true) do |images|
    SpriteHelper.javascript_style("CITYELEMS", images)
  end
